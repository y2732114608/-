...
async function scheduleTimer({
  ...
  return { totalWeek: 24, // 总周数：[1, 30]之间的整数
    startSemester: '1739664000000', // 开学时间：时间戳，13位长度字符串，推荐用代码生成
    ...
    sections: [{
      ...
      },
      {
        ...
        endTime: '09:30', // 结束时间：同上
      },
      {
        section: 3, // 节次：[1, 30]之间的整数
        startTime: '09:50', // 开始时间：参照这个标准格式5位长度字符串
      ...
      },
      {
        ...
        startTime: '11:35', // 开始时间：参照这个标准格式5位长度字符串
        endTime: '12:15', // 结束时间：同上
      },
      {
        section: 6, // 节次：[1, 30]之间的整数
        startTime: '13:30', // 开始时间：参照这个标准格式5位长度字符串
        endTime: '14:10', // 结束时间：同上
      },
      {
      ...
      },
      {
        ...
        startTime: '17:50', // 开始时间：参照这个标准格式5位长度字符串
        endTime: '18:30', // 结束时间：同上
      },
      {
        section: 11, // 节次：[1, 30]之间的整数
        startTime: '18:40', // 开始时间：参照这个标准格式5位长度字符串
        endTime: '19:20', // 结束时间：同上
      },
      {
